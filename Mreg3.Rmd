...
Für Ungarn HR, leigt er $0.56$ Saklenpunkte *unter* diesem Wert. 
...
Im einachsten Fall können wir berechnen, wieviel der Varianz die in den Random Effects des Nullmodells steckt, durch ein Modell mit Prädiktoren erklärt wird.




([Nakagawa/Schielzeth 2012](https://doi.org/10.1111/j.2041-210x.2012.00261.x))

Falls Sie noch die Zahlen vielleicht 

fragen Sie sich jetzt: Moment: wieso ändert sich etwas an der



```{r}
1-(as.data.frame(VarCorr(mreg1),comp="Variance")[,4]/as.data.frame(VarCorr(mreg0),comp="Variance")[,4])
```

Hier nochmal das Nullmodell zum Vergleich:
