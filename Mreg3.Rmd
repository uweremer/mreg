...
$\gamma_{01j}$ ist also Regressionskoeffizient für den Einfluss der Variable `bildung_agg` auf den variierenden Intercept und $\gamma_{02j}$ der Einfluss der Variable `c_ticpi_2018`.
...
Das konditional e$R^2$ erhöt sich minimal von $44.1$ auf $46.7$. 
