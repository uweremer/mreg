...
Im vorigen [Video 2](Mreg2.html) haben wir gesehen, wie man mit Hilfe des sogenannten Nullmodells berechnet, ob eine Mehrebenenregression überhaupt notwendig ist.
...
Das Umbenennen von Variablen, recodieren oder transformieren von Variablen kann man natürlich auch mit Funktionen des [`dplyr`](https://dplyr.tidyverse.org/)-Paketes oder mit [`sjmisc`](https://strengejacke.github.io/sjmisc/) umsetzen und im "tidyverse"-Stil mit dem Pipe-Operator schreiben.
...
Im den nächsten [Videos 4](Mreg4.html) und [5](Mreg5.html) werden wir dann die unterschiedlichen Modellvarianten der Mehrebenenregression in R schätzen. 
