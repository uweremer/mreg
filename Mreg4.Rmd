...
Im vorigen [Video 2](Mreg2.html) haben wir gesehen, wie man mit Hilfe des sogenannten Nullmodells berechnet, ob eine Mehrebenenregression überhaupt notwendig ist. Und in [Video 3](Mreg3.html), wie man die Daten für die Mehrebenenregression vorbereitet.
...
In [Video 5](Mreg5.html) erweitern wir dann diese Modelle um variierenden Slopes und Cross-Level-Interaktionen.
...
<p class=math_left> 
$\beta_{0j} = \gamma_{00} +$
<font color=red>$\gamma_{01j}$</font>
$+ u_{0j}$
</p>
</div>
...
Im nächsten [Video 5](Mreg5.html) werden wir dann das Varying Slope Modell und das Modell mit Cross-Level Interaktion anschauen und klären, wie man herausfindet, welches Modell das passende ist.
