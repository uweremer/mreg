...
Für Schweden und Norwegen dagegen unterschätzen wir mit der Regressionsgeraden das politische Vertrauen. Die Residuen sind also im Schnitt positiv.
...
Als Folge werden möglicherweise die Standardfehler unterschätzt. 
...
### Eine naheliegnde Lösung {.unnumbered}

Vielleicht werden Sie jetzt sagen, es gibt doch eine naheliegende Lösung: 
Können wir nicht zum Beispiel einfach Länderdummies ins Regressionsmodell mit aufnehmen?
Was wäre die Lösung? 


Die OLS Regression liefert unverzerrte und effiziente Schätzungen, wenn d
