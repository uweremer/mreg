...
ggplot(data=ess_c6,
  ...
  annotation_custom(grob = grid::textGrob(label = "7 x Slope b", 
                    ...
                    ymin = 3,
                    ymax = 3) +
  annotation_custom(grob = grid::textGrob(label = expression(hat(y)==5), 
...
<font color=blue>$`r round(coef(fit)[1],1)`$</font>
$+$
<font color=darkorange>$`r round(coef(fit)[2],1)`$
$\times 7$</font>
<font color=red>$=5$</font>
</p>


Dann sind wir bei `r round(coef(fit)[1],1) + 7*round(coef(fit)[2],1)` als Vorhersagewert für Menschen mit einer Wirtschaftszufriedenheit  von 7 Punkten.
