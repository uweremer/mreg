...
lm_df <- data.frame(b1 = c(b_cntry[1], b_cntry[1]+c(b_cntry[3:7])),
                    b2 = b_cntry[2])
lm_df$cntry <- sort(laender)
...
ggplot(ess_c6, 
  ...
  geom_vline(xintercept=0, col="black") +
  geom_hline(yintercept=0, col="black") +
  geom_abline(data=lm_df, aes(intercept=b1, slope=b2, group=cntry),
              color = farben, size=.5) 
