...
Leider nein. Weil variablität der Effekte überschätzt wird. Und auch die SE sind größer, da die L2 Einheiten unabhängig voneinsander betrachtet werde und die Informationen aus dem Rest des Samples ingnoriert werden.

DIe Mehrebenenregression ist ein Kompromiss. Schätzt die SE in dem es ** The partial_pooling model is designed for this problem and such, appropriately adjusts the standard error estimate by differentially weighting the sample size. I will try to come back and put in the different standard errors calculations for the three models.** 
